    ...
    <div className="relative h-auto md:h-[110vh] py-10 gap-8 overflow-hidden gradient">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 px-10 md:px-[6.8rem] py-5">
        ...
        >
          ...
          <h2 className="text-white text-xl md:text-2xl text-left">Pushing Our Limits With Game Development</h2>
          <p className="text-[#afafc0] text-[0.7rem] md:text-[1rem]">{data[id].content}</p>
